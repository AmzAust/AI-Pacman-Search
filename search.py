...
def depthFirstSearch(problem):
    ...
    """
    "*** YOUR CODE HERE ***"
    visitedNodes = set() #Create set to add visited nodes to
    start = problem.getStartState() 
    myStack = util.Stack() #Use stack for DFS
    frontier = myStack
    # Add starting state, empty list and cost value on to stack
    frontier.push((start, list(), 0))
        ...
        if successor not in visitedNodes:
            ...
            for newSuccessor, newAction, newStepCost in problem.getSuccessors(successor):
                if newSuccessor not in visitedNodes:
                    ...
                    frontier.push((newSuccessor, action + [newAction], newStepCost))
...
def breadthFirstSearch(problem):
    ...
    visitedNodes = set()
    start = problem.getStartState()
    myQueue = util.Queue() # Use queue for BFS
    frontier = myQueue 
     # Add starting state, empty list and cost value on to stack
    frontier.push((start, list(), 0))
    # While there is still a frontier do this
...
def uniformCostSearch(problem):
    ...
    visitedNodes = set()
    start = problem.getStartState()
    myPriorityQueue = util.PriorityQueue() #Use Priority Queue for UCS
    ...
    while frontier: 
        ...
        if successor not in visitedNodes:
            ...
            for newSuccessor, newAction, newStepCost in problem.getSuccessors(successor):
                if newSuccessor not in visitedNodes:
                    # Push the new information onto the stack and add new action to the list
                    # This time calculate the total cost of the steps
                    # Priority Queue will search for the lowest of the totals first
                    frontier.push((newSuccessor, action + [newAction], stepCost + newStepCost), stepCost + newStepCost)
        if successor in visitedNodes:
            pass
    return list() # Return an empty list
